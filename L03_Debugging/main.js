...
class Person {
    constructor(_firstName, _lastName, _dateOfBirth, _mom, _dad) {
        this.firstName = _firstName;
        this.lastName = _lastName;
        this.dateOfBirth = _dateOfBirth;
        this.mom = _mom;
...
class Familytree {
    ...
    static buildTree() {
        let willi = new Person("Willi", "Cambridge", new Date(1982, 7, 21), null, null);
        let diana = new Person("Diana", "Spencer", new Date(1961, 7, 1), null, null);
        let franzi = new Person("Franzi", "Roche", new Date(1936, 1, 20), null, null);
        let ruth = new Person("Ruth", "Gill", new Date(1908, 6, 7), null, null);
        let moritz = new Person("Moritz", "Roche", new Date(1885, 7, 8), null, null);
        let eddie = new Person("Eddie", "Spencer", new Date(1924, 1, 24), null, null);
        let cynthia = new Person("Cynthia", "Hamilton", new Date(1897, 8, 16), null, null);
        let albert = new Person("Albert", "Spencer", new Date(1892, 5, 23), null, null);
        let charlie = new Person("Charlie", "Wales", new Date(1948, 11, 14), null, null);
        let sarah = new Person("Sarah", "Windsor", new Date(1926, 4, 21), null, null); //else geht leider nicht weil ts/js kein namespacing hat xD
        let lisbeth = new Person("Lisbeth", "Bowes-Lyon", new Date(1900, 8, 4), null, null);
        let schorsch = new Person("Schorsch-Albert", "York", new Date(1895, 12, 14), null, null);
        let philip = new Person("Philip", "Battenberg", new Date(1921, 6, 10), null, null);
        let alice = new Person("Alice", "Battenberg", new Date(1885, 2, 25), null, null);
        let andi = new Person("Andi", "ElGreco", new Date(1882, 2, 1), null, null);
        willi.mom = diana;
        diana.mom = franzi;
        franzi.mom = ruth;
        franzi.dad = moritz;
...
//Main
let rootPerson = Familytree.buildTree();
let found = Familytree.find(rootPerson);
console.log(found);
